...
class MyPasswordChangeForm(PasswordChangeForm):
    ...
    new_password2=forms.CharField(label='Confirm New Password',widget=forms.PasswordInput(attrs={'class':'form-control','autofocus':'True','autocomplete':'current-password'}))
